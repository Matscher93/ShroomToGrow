...
enum XpSource { TOTAL_NODES, SYMBIOSIS_LEVELS, PRESTIGE_COUNT, ACHIEVEMENT_TIERS,
	WELL_PROJECTS, MISSIONS_COMPLETED, STORAGE_AREAS }
...
## Cost curve for buying Biome Size, paid in nutrients: size_base_cost * size_cost_growth^(size * size_cost_growth_exponent^size).
